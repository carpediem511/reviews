let reviews = [
...

  {
    ...
    text: "У тебя всё очень хорошо получается, видно прогресс. Молодец, что дополнительно разобралась с формой - это очень полезный и важный навык уметь самостоятельно находить информацию. Отличное форматирование кода и хорошая вёрстка! Очень здорово, что используешь семантические теги, огромный плюс!<br> <br></br>",
    author:
      "Сапожникова Лилия Евгеньевна, основатель онлайн-школы программирования BitByBit",
...

  {
    ...
    text: "Посмотрела форму. В целом мне нравится, всё логично и понятно. Наверное, хотелось бы чуть понятнее названия классов, но понимаю, что это сложно подбирать. Нравится, что используешь переменные и псевдоклассы, получились кастомные чекбоксы. И, главное, форма работает и корректно отправляются значения!<br> <br><br><br> <br>",
    author:
      "Сапожникова Лилия Евгеньевна, основатель онлайн-школы программирования BitByBit",
    date: "март, 2022 год",
  },

  {
    ...
    text: "Понравилась структура вёрстки и форматирование. Всё выровнено по сетке - тут вообще нет замечаний, идеально! Отлично получились градиенты и тени. Отдельный плюс за использование git, вижу много коммитов; и, конечно, за кастомный домен. Очень аккуратно и хорошо вышла адаптивная вёрстка, учитывая ещё то, что её надо было придумать самостоятельно. Работа одна из лучших, очень здорово получилось! Молодец!",
    author:
      "Сапожникова Лилия Евгеньевна, основатель онлайн-школы программирования BitByBit",
